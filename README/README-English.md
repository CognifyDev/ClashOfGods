...
The plugin system provides access to various built-in functions for logging, game interaction, and more. Refer to the [Built-in Functions Guide](README/Plugin/Builtins.md) for comprehensive API documentation.
...
- **Plugin Development Guide**: [First Plugin Guide](README/Plugin/FirstPlugin.md)
- **Built-in API Reference**: [Built-in Functions](README/Plugin/Builtins.md)
- **Plugin System Overview**: [About Plugin System](README/Plugin/About.md)
