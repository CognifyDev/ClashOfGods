...
#pragma warning disable CS8603
    public class TextField : MonoBehaviour
    {
        ...
        private void UpdateTextMesh()
        {
            ...
            Vector2 compoPos = CameraUtils.WorldToScreenPoint(transform.position + new Vector3(GetCursorX(cursor), 0.15f, 0f), LayerMask.NameToLayer("UI"));
        ...
        public void Update()
        {
            ...
            if (Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl))
            {
                ...
                {
                    InputText(TextUtils.GetClipboardString());
                    requireUpdate = true;
                }
            }
    ...
    public class VanillaAsset
    {
        public class VanillaAudioClip
        {
            ...
            public AudioClip Clip
            {
                ...
                {
                    if (clip) return clip;
                    clip = ResourceUtils.FindAsset<AudioClip>(name);
                    return clip!;
                }
            }
        ...
        static public Material OblongMaskedFontMaterial
        {
            get
            {
                if (oblongMaskedFontMaterial == null) oblongMaskedFontMaterial = ResourceUtils.FindAsset<Material>("Brook Atlas Material Masked");
        ...
        static public TMP_FontAsset PreSpawnFont
        {
            get
            {
                if (preSpawnFont == null) preSpawnFont = ResourceUtils.FindAsset<TMP_FontAsset>("DIN_Pro_Bold_700 SDF")!;
                return preSpawnFont;
            }
        }
        static public Material StandardMaskedFontMaterial
        {
            get
            {
                if (standardMaskedFontMaterial == null) standardMaskedFontMaterial = ResourceUtils.FindAsset<Material>("LiberationSans SDF - BlackOutlineMasked")!;
        ...
        static public TMP_FontAsset VersionFont
        {
            get
            {
                if (versionFont == null) versionFont = ResourceUtils.FindAsset<TMP_FontAsset>("Barlow-Medium SDF");
                return versionFont!;
            }
        }
        ...
        static public TMP_FontAsset BrookFont
        {
            get
            {
                if (brookFont == null) brookFont = ResourceUtils.FindAsset<TMP_FontAsset>("Brook SDF")!;
                return brookFont;
            }
        }
        ...
        public static Material GetHighlightMaterial()
        {
            ...
            foreach (var mat in UnityEngine.Resources.FindObjectsOfTypeAll(Il2CppInterop.Runtime.Il2CppType.Of<Material>()))
            {
        ...
        static public void LoadAssetsOnTitle()
        {
            ...
            CloseButtonSprite = ResourceUtils.FindAsset<Sprite>("closeButton")!;
        ...
        {
            if (Loaded) return;
            PlayerOptionsMenuPrefab = ResourceUtils.FindAsset<PlayerCustomizationMenu>("LobbyPlayerCustomizationMenu")!;
            Loaded = true;
        }
        ...
        static public Scroller GenerateScroller(Vector2 size, Transform transform, Vector3 scrollBarLocalPos, Transform target, FloatRange bounds, float scrollerHeight)
        {
            ...
            var scroller = GameObjectUtils.CreateObject<Scroller>("Scroller", transform, new Vector3(0, 0, 5));
