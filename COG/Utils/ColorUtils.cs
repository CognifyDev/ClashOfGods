...
public static class ColorUtils
{
    ...
    {
        return new Color(color32.r / (float)byte.MaxValue, color32.g / (float)byte.MaxValue,
            color32.b / (float)byte.MaxValue,
            color32.a / (float)byte.MaxValue);
    }
    ...
    public static Color AsColor(string color)
    {
        ...
        return FromColor32(red, green, blue);
    }
}