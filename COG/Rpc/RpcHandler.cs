...
public interface IRpcHandler
{
    ...
    public static void Register(IRpcHandler handler)
    {
...
public class RpcHandler<T> : IRpcHandler where T : notnull
{
    ...
    public RpcHandler(KnownRpc callId, Action<T> onPerform, Action<RpcWriter, T> onSend,
        Func<MessageReader, T> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }

    public RpcHandler(RpcCalls callId, Action<T> onPerform, Action<RpcWriter, T> onSend,
        Func<MessageReader, T> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }
    ...
    {
        OnSend(RpcWriter.Start(CallId), arg);
    }
...
{
    public RpcHandler(byte callId, Action<T1, T2> onPerform, Action<RpcWriter, T1, T2> onSend,
        Func<MessageReader, (T1, T2)> onReceive)
    {
        CallId = callId;
        OnPerform = onPerform;
    ...
    public RpcHandler(KnownRpc callId, Action<T1, T2> onPerform, Action<RpcWriter, T1, T2> onSend,
        Func<MessageReader, (T1, T2)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }

    public RpcHandler(RpcCalls callId, Action<T1, T2> onPerform, Action<RpcWriter, T1, T2> onSend,
        Func<MessageReader, (T1, T2)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }
    ...
    {
        OnSend(RpcWriter.Start(CallId), arg1, arg2);
    }
...
{
    public RpcHandler(byte callId, Action<T1, T2, T3> onPerform, Action<RpcWriter, T1, T2, T3> onSend,
        Func<MessageReader, (T1, T2, T3)> onReceive)
    {
        CallId = callId;
        OnPerform = onPerform;
    ...
    public RpcHandler(KnownRpc callId, Action<T1, T2, T3> onPerform, Action<RpcWriter, T1, T2, T3> onSend,
        Func<MessageReader, (T1, T2, T3)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }

    public RpcHandler(RpcCalls callId, Action<T1, T2, T3> onPerform, Action<RpcWriter, T1, T2, T3> onSend,
        Func<MessageReader, (T1, T2, T3)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }
    ...
    {
        OnSend(RpcWriter.Start(CallId), arg1, arg2, arg3);
    }
...
public class RpcHandler<T1, T2, T3, T4> : IRpcHandler
    where T1 : notnull where T2 : notnull where T3 : notnull where T4 : notnull
{
    public RpcHandler(byte callId, Action<T1, T2, T3, T4> onPerform, Action<RpcWriter, T1, T2, T3, T4> onSend,
        Func<MessageReader, (T1, T2, T3, T4)> onReceive)
    {
        CallId = callId;
        OnPerform = onPerform;
    ...
    public RpcHandler(KnownRpc callId, Action<T1, T2, T3, T4> onPerform, Action<RpcWriter, T1, T2, T3, T4> onSend,
        Func<MessageReader, (T1, T2, T3, T4)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }

    public RpcHandler(RpcCalls callId, Action<T1, T2, T3, T4> onPerform, Action<RpcWriter, T1, T2, T3, T4> onSend,
        Func<MessageReader, (T1, T2, T3, T4)> onReceive) : this((byte)callId, onPerform, onSend, onReceive)
    {
    }
    ...
    {
        OnSend(RpcWriter.Start(CallId), arg1, arg2, arg3, arg4);
    }
...
public class RpcHandler<T1, T2, T3, T4, T5> : IRpcHandler where T1 : notnull
    where T2 : notnull
    where T3 : notnull
    where T4 : notnull
    where T5 : notnull
{
    public RpcHandler(byte callId, Action<T1, T2, T3, T4, T5> onPerform, Action<RpcWriter, T1, T2, T3, T4, T5> onSend,
        Func<MessageReader, (T1, T2, T3, T4, T5)> onReceive)
    {
        CallId = callId;
        OnPerform = onPerform;
    ...
    public RpcHandler(KnownRpc callId, Action<T1, T2, T3, T4, T5> onPerform,
        Action<RpcWriter, T1, T2, T3, T4, T5> onSend, Func<MessageReader, (T1, T2, T3, T4, T5)> onReceive) : this(
        (byte)callId, onPerform, onSend, onReceive)
    {
    }

    public RpcHandler(RpcCalls callId, Action<T1, T2, T3, T4, T5> onPerform,
        Action<RpcWriter, T1, T2, T3, T4, T5> onSend, Func<MessageReader, (T1, T2, T3, T4, T5)> onReceive) : this(
        (byte)callId, onPerform, onSend, onReceive)
    {
    }
    ...
    public void Perform(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
    {
        OnPerform(arg1, arg2, arg3, arg4, arg5);
    }
    ...
    {
        OnSend(RpcWriter.Start(CallId), arg1, arg2, arg3, arg4, arg5);
    }
